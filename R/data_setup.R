...
# Dane za lata 1964–2023 są ostateczne, natomiast dane za okres styczeń 2024 – grudzień 2024 są tymczasowe (prowizoryczne)

# unknown to miejsce na dane nieprzypisane do konkretnego kraju, nie było żadnych przyjeżdząjących z takich mikejsc
# liczba odwiedzających dla tych kraji to 0, więc chyba można bezpiecznie usunąć "unknown" z danych
# kraj "unknown" też ma wskaźnik wzrostu jako -100, co chyba oznacza brak danych
